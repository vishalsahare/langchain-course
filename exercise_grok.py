...
def implement_llama_4_model():
    ...
    llm = ChatGroq(model="llama-4-8b-instant", temperature=0)
    return llm
...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    llm4 = implement_llama_4_model()
    llm3_3 = implement_llama_3_3_model()
    response1 = implement_query_model(llm4, prompt)
    response2 = implement_query_model(llm3_3, prompt)
    return {"llama-4-8b-instant": response1, "llama-3.3-70b-versatile": response2}
